...
Superseded in part by [ADR-0010](0010-budget-guard.md): §7's `clear` target is the subtree minus the `blocked` sentinel, and `--no-cache` does not bypass that sentinel
